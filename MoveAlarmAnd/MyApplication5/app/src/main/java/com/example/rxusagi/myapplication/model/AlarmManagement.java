...
public class AlarmManagement {
    ...
    public long getNextTimeMillisec() {
        ...
        if(todayHasnext()) {
            int i = calendar.get(Calendar.HOUR_OF_DAY) * 3600000 + calendar.get(Calendar.MINUTE) * 60000 + calendar.get(Calendar.SECOND) * 1000;
            i = -i + alarmState.getStartofficetimehr()*3600000 + alarmState.getStartofficetimemn()*60000;
            if(i > 0){
